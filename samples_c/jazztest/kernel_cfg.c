/*
 *  kernel_cfg.c
 *  Tue May 04 12:45:45 2010
 *  SG Version 2.00
 *  sg ./sonartest.oil -os=ECC2 -I../../ecrobot/../toppers_osek/sg/impl_oil -template=../../ecrobot/../toppers_osek/sg/lego_nxt.sgt
 */
...
const FP tinib_task[TNUM_TASK] = { TASKNAME( Task1 ), TASKNAME( Task2 ), TASKNAME( DegPSCounter ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_Task1, (__STK_UNIT)_stack_Task2, (__STK_UNIT)_stack_DegPSCounter, };
...
static void _activate_alarm_DegPS_alarm( void );
static void _activate_alarm_DegPS_alarm( void )
{ (void)ActivateTask( DegPSCounter ); }

const CounterType alminib_cntid[TNUM_ALARM] = { 0, 0, 0, };
const FP alminib_cback[TNUM_ALARM] = { _activate_alarm_cyclic_alarm1, _activate_alarm_cyclic_alarm2, _activate_alarm_DegPS_alarm, };
...
const TickType alminib_cycle[TNUM_ALARM] = { 50, 500, 1, };
